...
public class Collision {
    ...
    public static boolean canMove(int nextX, int nextY) {
        ...
        return !((_map[nextY_1][nextX_1] == '#' || _map[nextY_1][nextX_1] == '*' || _map[nextY_1][nextX_1] == 'f' || _map[nextY_1][nextX_1] == 'b') ||
                (_map[nextY_2][nextX_2] == '#' || _map[nextY_2][nextX_2] == '*' || _map[nextY_2][nextX_2] == 'f' || _map[nextY_2][nextX_2] == 'b') ||
                (_map[nextY_3][nextX_3] == '#' || _map[nextY_3][nextX_3] == '*' || _map[nextY_3][nextX_3] == 'f' || _map[nextY_3][nextX_3] == 'b') ||
                (_map[nextY_4][nextX_4] == '#' || _map[nextY_4][nextX_4] == '*' || _map[nextY_4][nextX_4] == 'f' || _map[nextY_4][nextX_4] == 'b'));
    }
